export const photographeArgentiqueData = {
    fr: {
        seo: {
        ...
        sections: [
            {
                title: "Pourquoi choisir l'esthétique argentique à l'ère du numérique ?",
                content: [
                    {
            ...
            {
                title: "Une vision d'auteur : De l'errance urbaine à la collection",
                content: [
                    {
                        text: [
        ...
        technical_section: {
            title: "Dans les coulisses : Matériel et Technique",
            items: [
                {
        ...
        faq: {
            ...
            items: [
                ...
                {
                    q: "Comment est assurée l'authenticité de l'œuvre ?",
                    a: "Chaque tirage est livré avec un certificat d'authenticité signé, garantissant son origine, son numéro dans la série et les détails techniques de la prise de vue et du tirage."
                },
                {
        ...
        opening: {
            quote: "\"Commencer une collection, c'est investir dans la mémoire.\"",
            text: "",
            cta_portfolio: "Voir les Séries",
            cta_shop: "Accéder à la Boutique"
        }
    },
    // For now, English duplicates French structure to avoid valid compilation errors if language toggles, 
    en: {
        seo: {
            title: "Analog Photographer Paris: Fine Art Prints & Portfolio | Borntwolate",
            description: "Analog photographer based in Paris. Borntwolate captures urban melancholy and wandering. Discover limited fine art prints (Museum Quality / Picto) for demanding collectors."
        },
        hero: {
        ...
        sections: [
            {
                title: "Why choose the analog aesthetic in the digital age?",
                content: [
                    {
            ...
            {
                title: "An author's vision: From urban wandering to collection",
                content: [
                    {
                        text: [
        ...
        technical_section: {
            title: "Behind the scenes: Gear and Technique",
            items: [
                {
        ...
        faq: {
            ...
            items: [
                ...
                },
                {
                    ...
                    a: "Craftsmanship takes time. Each print is made to order by the Picto laboratory in Paris. Generally allow between 10 and 15 days for production, quality control, and secure shipping in reinforced packaging."
                },
                {
                    q: "How is the authenticity of the work ensured?",
                    a: "Each print is delivered with a signed certificate of authenticity, guaranteeing its origin, its number in the series, and the technical details of the shot and print."
                },
                {
        ...
        opening: {
            quote: "\"Starting a collection is investing in memory.\"",
            text: "",
            cta_portfolio: "View Series",
            cta_shop: "Access Shop"
        }
    },
};
