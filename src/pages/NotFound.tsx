...
const NotFound = () => {
    return (
        <>
            <SEO
                title="404 - Exposition Ratée"
                description="Cette image a été perdue au développement. Le négatif est vierge."
            />
            ...
            <div className="min-h-screen w-full flex flex-col items-center justify-center bg-black text-off-white relative overflow-hidden">
                ...
                >
                    <h1 className="font-space-mono text-6xl md:text-9xl font-bold mb-4 text-darkroom-red mix-blend-screen tracking-tighter opacity-90 relative inline-block">
                        <span className="absolute -left-1 -top-0.5 text-blue-500 mix-blend-screen opacity-70 animate-pulse">404</span>
                        404
                    </h1>
                    ...
                    <p className="font-inter font-light text-silver max-w-md mx-auto mb-10 opacity-70">
                        Cette image a été perdue au développement. <br /> Le négatif est vierge.
                    </p>
